  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'elevation-2':
          '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06), 0 1px 0 0 rgba(255, 255, 255, 0.1) inset', // Medium
        'elevation-3':
          '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05), 0 1px 0 0 rgba(255, 255, 255, 0.1) inset', // High
