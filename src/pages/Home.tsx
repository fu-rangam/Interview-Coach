      ...
      <div className="relative z-10 w-full max-w-5xl px-4 md:px-6">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
            Your all-in-one platform for career success. Build skills, craft the perfect resume, and
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Training Module */}
          <GlassCard className="p-8 flex flex-col items-center text-center group hover:bg-white/5 transition-all duration-300 border-white/5 hover:border-white/10">
            ...
            <p className="text-gray-400 text-sm mb-8 flex-1">
              Access our extensive e-learning library to upskill and certifications to boost your
              profile.
            </p>
            <GlassButton
              variant="default"
          ...
          <GlassCard className="p-8 flex flex-col items-center text-center group hover:bg-white/5 transition-all duration-300 border-cyan-500/30 hover:border-cyan-400/50 shadow-glow-cyan">
            ...
            <p className="text-gray-400 text-sm mb-8 flex-1">
              Practice with an AI coach that provides real-time feedback on your delivery and
              answers.
            </p>
            <GlassButton onClick={() => navigate('/interview')} className="w-full group/btn">
              Start Practicing{' '}
              <ArrowRight
                size={16}
