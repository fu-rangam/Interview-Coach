        ...
        <div className="flex-1 overflow-y-auto w-full p-8 md:p-12">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="w-full h-32 rounded-xl bg-white border border-slate-200 shadow-sm p-6 flex flex-col justify-center space-y-4"
              >
          ...
          {variant === 'review' ? (
            <div className="w-full h-full md:overflow-y-auto p-6 md:p-12 max-w-xl mx-auto pb-24">
              ...
              <div className="space-y-4">
                ...
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="w-full h-16 rounded-xl bg-white border border-slate-200 shadow-sm p-4 flex items-center gap-3"
                  >
            ...
            <div className="w-full mx-auto space-y-6">
              ...
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="w-full h-32 rounded-xl bg-white border border-slate-200 p-4 space-y-3 shadow-sm"
                >
