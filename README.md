...
![Preview Screenshots](./public/dashboard-preview.png) _(Note: Placeholder for actual screenshot)_
...
- **Dimension Scoring**: Scores you on specific competencies (e.g., "Technical Depth", "Communication") relevant _only_ to the question asked.
